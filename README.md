...
LoRa Мульти-контроллер — это система беспроводного управления реле, построенная на базе микроконтроллеров ESP32-C6 (передатчик) и Arduino Nano (приёмник). Система позволяет управлять несколькими приёмниками через веб-интерфейс или специализированное настольное приложение.
